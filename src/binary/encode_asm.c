...
enum asm_instruction {
    ...
    AI_PUSH, 
    AI_POP, 
    AI_LEA,  // see https://stackoverflow.com/questions/1658294/whats-the-purpose-of-the-lea-instruction
    // arithmetic
    AI_ADD, 
    AI_SUB,
    AI_INC,
...
// need 32-bit flag? need mask for jump addresses? etc
bool encode_asm(char *instruction, char *op1, char *op2, char *output, int *out_len) {
    return false;
}
